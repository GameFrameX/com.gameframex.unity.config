...
Game Frame X Config는 GameFrameX 프레임워크 기반의 Unity 설정 테이블 패키지로, 설정 관리를 더 간단하고 효율적으로 만들어 줍니다.

**Config 컴포넌트 (Config Component)** - 설정 테이블 관련 인터페이스를 제공합니다.
...
2. `manifest.json`의 `dependencies`에 직접 추가:
   ...
   ```
3. Unity의 **Package Manager**에서 **Git URL**을 사용하여 추가: `https://github.com/gameframex/com.gameframex.unity.config.git`
...
- `com.gameframex.unity.asset`: GameFrameX Asset 패키지
- `com.gameframex.unity.event`: GameFrameX Event 패키지

## 문서 및 자료

- 문서: https://gameframex.doc.alianblank.com
- 저장소: https://github.com/gameframex/com.gameframex.unity.config
- 이슈: https://github.com/gameframex/com.gameframex.unity.config/issues
...
[Releases](https://github.com/GameFrameX/gameframex/com.gameframex.unity.config/releases)에서 변경 로그를 확인하세요.
## 라이선스
